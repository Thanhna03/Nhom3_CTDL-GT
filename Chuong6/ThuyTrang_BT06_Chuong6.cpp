...
int main()
{
	int choice, x, i;
	system("cls");
	cout << "====BAI TAP 6, CHUONG 6, TIM KIEM CAY KHUNG TOI THEU, PRIM=======" << endl;
	cout << "1. Khoi tao ma tran ke rong" << endl;
	cout << "2. Nhap ma tran ke tu file text" << endl;
	cout << "3. Nhap ma tran ke" << endl;
	cout << "4.Xuat ma tran ke" << endl;
	cout << "5.Tim cay khung toi thieu bang Kruskal duoc cai tien" << endl<<endl;
	cout << "0.Thoat\n";
	do
	{
		...
		case 5:
			...
			cin >> x;
			kruskal(x);
			cout << "Cau khung toi thieu voi Kruskal duoc cai tien"<<endl;
			output(true);
			break;
		default:
			choice=0;
